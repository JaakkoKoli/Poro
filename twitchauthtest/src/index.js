...
app.get('/', async (request, response) => {
    if(request.query.code){
        ...
        const req='https://api.twitch.tv/api/oauth2/token?client_id=pho06vchppcq16eknimsbqagdxkxya&client_secret=q5g6fchyrknt58zamrfo1nabsh0giz&code='+code+'&grant_type=authorization_code&redirect_uri=http://localhost:3001'
        axios.post(req)
            .then(res=>{
    ...
    response.send('<div><a href="https://api.twitch.tv/kraken/oauth2/authorize?client_id=pho06vchppcq16eknimsbqagdxkxya&redirect_uri=http://localhost:3001&response_type=code">authorise</a></div>')
})
